...
export default function ClassDetail() {
  ...
  const [classData, setClassData] = useState({
    ...
    students: [
      { id: 1, name: 'Emma Johnson', email: 'emma.j@example.com', grade: 'A', attendance: '95%' },
      { id: 2, name: 'Noah Williams', email: 'noah.w@example.com', grade: 'B+', attendance: '90%' },
      { id: 3, name: 'Olivia Brown', email: 'olivia.b@example.com', grade: 'A-', attendance: '98%' },
      { id: 4, name: 'Liam Davis', email: 'liam.d@example.com', grade: 'B', attendance: '85%' },
      { id: 5, name: 'Ava Miller', email: 'ava.m@example.com', grade: 'A', attendance: '92%' }
    ],
    materials: [
      { id: 1, name: 'Course Syllabus', type: 'PDF', date: '2025-01-15' },
      { id: 2, name: 'Lecture Notes - Week 1', type: 'PDF', date: '2025-01-20' },
      { id: 3, name: 'Assignment #1', type: 'DOCX', date: '2025-01-25' },
      { id: 4, name: 'Midterm Study Guide', type: 'PDF', date: '2025-03-10' }
    ],
    announcements: [
      { id: 1, title: 'Final Exam Schedule', content: 'The final exam will be held on June 15, 2025 from 9:00 AM to 12:00 PM in Room 101.', date: '2025-05-01' },
      { id: 2, title: 'Project Deadline Extended', content: 'The deadline for the final project has been extended to May 25, 2025.', date: '2025-04-28' }
    ]
  });
  ...
  useEffect(() => {
    ...
    // In a real application, fetch class data based on classId
